...
async function registerVote(client) {
...
Não usamos .select() depois do insert.

A política atual da tabela votes
...
async function consumeAccessCode(client) {
